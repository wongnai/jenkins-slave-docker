...
ARG SWARM_VERSION=3.10
ARG SWARM_SHA=51fbd35952670a4d51e3d73831813823344840ff
# Container User
...
ARG TINI_SHA=cc179978868ca0c4a0bc87387c6bf2adab50e29e
 
ARG DOCKER_TAR_NAME=docker-17.12.0-ce.tgz
